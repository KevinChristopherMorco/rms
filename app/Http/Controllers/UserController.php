...
class UserController extends Controller
{
    ...
    public function home()
    {
        ...
        $pendingBookData =  DB::table('books')->join('book_reservations', 'books.id', '=', 'book_reservations.book_id')->where('book_reservations.user_id', '=',  $authSessionId)->where('book_reservations.reservation_status', '=', 'Pending')->select('books.*')->paginate(3, '[*]', 'PendingPage');
        $aprroveBookData =  DB::table('books')->join('book_reservations', 'books.id', '=', 'book_reservations.book_id')->where('book_reservations.user_id', '=',  $authSessionId)->where('book_reservations.reservation_status', '=', 'Approved')->select('books.*')->paginate(3, '[*]', 'AcceptPage');
        $declineBookData =  DB::table('books')->join('book_reservations', 'books.id', '=', 'book_reservations.book_id')->where('book_reservations.user_id', '=',  $authSessionId)->where('book_reservations.reservation_status', '=', 'Declined')->select('books.*')->paginate(3, '[*]', 'DeclinePage');
        $confirmBookData =  DB::table('books')->join('book_reservations', 'books.id', '=', 'book_reservations.book_id')->where('book_reservations.user_id', '=',  $authSessionId)->where('book_reservations.reservation_status', '=', 'Confirmed')->select('books.*')->paginate(3, '[*]', 'ConfirmPage');
