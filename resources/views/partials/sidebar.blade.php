<div class="admin-sidebar">
    <ul class="admin-sidebar-items px-4">
        ...
        <div class="admin-sidebar-item-group danger-zone py-4">
            ...
            <li class="{{Route::is('book.archive') ? 'admin-sidebar-danger--active' : '' }} admin-sidebar-subheading text-sm py-2"><a href="{{route('book.archive')}}"><i class="fa-solid fa-box-archive"></i><span class="list-text">Archive Books</span></a></li>
            <li class="{{Route::is('admin.suspend') ? 'admin-sidebar-danger--active' : ''}} admin-sidebar-subheading text-sm py-2"><a href="{{route('admin.suspend')}}"><i class="fa-solid fa-user-slash"></i><span class="list-text">Suspended Users</span></a></li>
