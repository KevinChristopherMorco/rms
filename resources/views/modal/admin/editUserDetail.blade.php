<div class="main-modal-user-edit fixed w-full h-100 inset-0 z-50 overflow-hidden flex justify-center items-center animated fadeIn faster hidden"
            ...
            <div class="modal-content-container my-5">
                ...
                <div class="main-modal-edit__modal-content">
                    <div class="main-modal-edit__input-container" style="overflow-y:scroll; height:500px;">
                        ...
                        <form class="main-modal-edit__form" action="{{route('user.update')}}" method="POST">
                            @csrf
                            @method('PUT')
                            <input class="modal-input" name="user_id" id="user-id" type="hidden">
