<div class="main-modal-view fixed w-full h-100 inset-0 z-50 overflow-hidden flex justify-center items-center animated fadeIn faster hidden"
    ...
    <div
        ...
        <div class=" py-4 text-left px-6">
            ...
            <!--Body-->
            <div class="main-modal-view__modal-content-container my-5">
                ...
                <div class="main-modal-view__modal-content">
                    <div style="overflow-y:scroll; height:500px;">
                        <table>
                            ...
                            <tr>
                                ...
                                <td id="publish-row"></td>
                            </tr>
                            <td class="font-bold">College</td>
                            <td id="college-row"></td>
                            </tr>
