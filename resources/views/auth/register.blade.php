                            ...
                            <div class="user-registration">
                                <form method="POST" action="{{ route('register.create') }}">
                                            ...
                                            <div class="col-span-1">
                                                ...
                                                <div class="text-center">
                                                    <input id="first_name" type="text"
                                                        ...
                                                        placeholder="Enter your first name" required autocomplete="name"
                                                        autofocus>
                                            ...
                                            <div class="col-span-1">
                                                ...
                                                <div class="text-center">
                                                    <input id="middle_name" type="text"
                                                        ...
                                                        placeholder="Enter your middle name" required autocomplete="name"
                                                        autofocus>
                                            ...
                                            <div class="col-span-1">
                                                ...
                                                <div class="text-center">
                                                    <input id="last_name" type="text"
                                                        ...
                                                        placeholder="Enter your last name" required autocomplete="name"
                                                        autofocus>
                                            ...
                                            <div class="col-span-1">
                                                ...
                                                <div class="text-center">
                                                    <input id="birthdate" type="text" onfocus="(this.type='date')"
                                                        ...
                                                        placeholder="Enter your birthdate" required autocomplete="email">
                                                    @error('date')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                    ...
                                    <div class="register-button flex justify-between items-center mr-4">
                                        <p class="account-indicator text-xs">Already have an account? <a
